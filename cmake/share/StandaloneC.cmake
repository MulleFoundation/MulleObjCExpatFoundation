if( NOT __STANDALONE_C_CMAKE__)
   ...
   if( STANDALONE)
      ...
      if( NOT STANDALONE_NAME)
         set( STANDALONE_NAME "MulleObjCExpatFoundation-standalone")
      endif()
      set( STANDALONE_DEFINITIONS ${MULLE_OBJC_EXPAT_FOUNDATION_DEFINITIONS})
      ...
      if( NOT STANDALONE_ALL_LOAD_LIBRARIES)
         set( STANDALONE_ALL_LOAD_LIBRARIES
            $<TARGET_FILE:MulleObjCExpatFoundation>
...
MulleObjCExpatFoundation-standalone.c with contents like this to it:
   int  ___mulle_objc_expat_foundation_unused__;
and everybody will be happy")
         ...
         add_dependencies( ${STANDALONE_NAME} MulleObjCExpatFoundation)
         if( STARTUP_NAME)
